...
=== In Rails 3
  ...
  BenchTest#test_erubis_partials (3.29 sec warmup)
             wall_time: 3.23 sec
                memory: 0.00 KB
               objects: 0
               gc_runs: 15
               gc_time: 0.62 ms
  BenchTest#test_erubis_single (740 ms warmup)
             wall_time: 711 ms
                memory: 0.00 KB
               objects: 0
               gc_runs: 4
               gc_time: 0.15 ms
  BenchTest#test_hammer_builder (3.14 sec warmup)
             wall_time: 875 ms
                memory: 0.00 KB
               objects: 0
               gc_runs: 5
